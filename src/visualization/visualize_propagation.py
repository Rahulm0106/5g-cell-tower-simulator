...
def plot_path_loss_comparison():
    ...
    # Save to results/plots folder at project root
    plot_dir = os.path.join(os.path.dirname(__file__), '..', '..', 'results', 'plots')
    os.makedirs(plot_dir, exist_ok=True)
    plot_path = os.path.join(plot_dir, 'path_loss_comparison.png')
...
def plot_coverage_map():
    ...
    plot_dir = os.path.join(os.path.dirname(__file__), '..', '..', 'results', 'plots')
    os.makedirs(plot_dir, exist_ok=True)
    plot_path = os.path.join(plot_dir, 'coverage_map.png')
    plt.savefig(plot_path, dpi=150, bbox_inches='tight')
    print("✅ Plot saved:", plot_path)
...
def plot_frequency_comparison():
    ...
    plot_dir = os.path.join(os.path.dirname(__file__), '..', '..', 'results', 'plots')
    os.makedirs(plot_dir, exist_ok=True)
    plot_path = os.path.join(plot_dir, 'frequency_comparison.png')
    plt.savefig(plot_path, dpi=150, bbox_inches='tight')
    print("✅ Plot saved:", plot_path)
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("\nGenerated files:")
    print("  - results/plots/path_loss_comparison.png")
    print("  - results/plots/coverage_map.png")
    print("  - results/plots/frequency_comparison.png")
